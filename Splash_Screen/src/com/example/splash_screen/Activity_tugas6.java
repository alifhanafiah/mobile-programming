...
public class Activity_tugas6 extends Activity {
...
//	isian dari list
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_activity_tugas6);
...
//				buatkan validasi pilihan
				AlertDialog.Builder validasi_pilihan_film = new AlertDialog.Builder(Activity_tugas6.this);
...
//				clear
        ...
        btn_back6.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent pindahtugas6 = new Intent();
				setResult(RESULT_OK, pindahtugas6);
				finish();
			}
		});
	}
