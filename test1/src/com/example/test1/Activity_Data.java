...
import com.example.parsing_data.R;
...
//		percabangan pemilihan nama
		if ("1".equalsIgnoreCase(Data_Tampung_Nobp)){
			Data_Tampung_Nama = "Muhammad";
		} else if ("2".equalsIgnoreCase(Data_Tampung_Nobp)){
			Data_Tampung_Nama = "Alif";
		} else if ("3".equalsIgnoreCase(Data_Tampung_Nobp)){
			Data_Tampung_Nama = "Muhammad";
		}
